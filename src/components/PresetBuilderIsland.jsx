...
import { SchemaTabs, SchemaTree } from './schema-tree.jsx';
      ...
      <div className="panorama-shell" role="region" aria-label="HP Colors preset builder">
        <header className="panorama-topbar">
          <div className="panorama-brand-block">
            ...
            <nav className="similar-tools" aria-label="Builder pages and similar tools">
              <span className="similar-tools-label">Pages</span>
              <a className="similar-tool-link" href={`${import.meta.env.BASE_URL}game-menu/`}>
                Game menu builder
              </a>
