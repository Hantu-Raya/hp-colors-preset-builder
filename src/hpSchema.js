...
const REWRITE_BINDING_DATA = [
  ...
  ["readoutOffsetX", "hp_readout_offset_x", "slider", "HP number horizontal offset", "HEALTH INFO|TEXT POSITION", 27, { min: -405, max: 405, step: 1 }, null, { id: "hp_counter_position", axis: "x" }],
  ["readoutOffsetY", "hp_readout_offset_y", "slider", "HP number vertical offset", "HEALTH INFO|TEXT POSITION", 500, { min: -35, max: 840, step: 1 }, null, { id: "hp_counter_position", axis: "y" }],
  ...
  ["lowThreshold", "hp_low_threshold", "slider", "Low HP starts at %", "HEALTH INFO|HP TEXT", 25, { min: 0, max: 99, step: 1 }],
  ["highThreshold", "hp_high_threshold", "slider", "High HP starts at %", "HEALTH INFO|HP TEXT", 65, { min: 1, max: 100, step: 1 }],
