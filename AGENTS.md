...
`F:\Users\FoxOS_User\Desktop\Deadlock-mods-collection\hp_colors_rewrite\panorama\layout\hud_escape_menu.xml` is the canonical Rewrite layout. `public/templates/hp_colors_rewrite/panorama/layout/hud_escape_menu.xml` must be an exact mirror so generated v2 preset VPKs remain compatible with the installed Rewrite runtime.
